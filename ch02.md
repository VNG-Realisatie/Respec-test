...
<dfn>Referentie</dfn>: Een referentie is een verwijzing naar een onject of omschrijving ergens op het internet.
...
Referentie uit locale lijst [[SemVer]] en [[xxxxx]]. Lijst staat in `organisation-config.js`. Alleen referenties die in de tekst voorkomen worden getoond.

We gebruiken een <a>definitie</a> om een woord te omschrijven.
Een <a>referentie</a> is een verwijzing.
